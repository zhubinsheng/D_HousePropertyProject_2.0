 ...
 * 主界面户型=>户型详情=>客服=>房产客服
 */
public class Act_HousePropertyCustomerService extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
        ...
        HttpHelper.syswordGetQuestion(this, type, new HttpHelper.HttpUtilsCallBack<String>() {
            ...
            public void onSucceed(String succeed) {
                ...
                if (adapter == null) {
                    ...
                    adapter.setOnItemClickListener(Act_HousePropertyCustomerService.this);
