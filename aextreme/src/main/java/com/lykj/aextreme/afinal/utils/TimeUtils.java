...
import static com.lykj.aextreme.afinal.utils.ConstUtils.*;
...
public class TimeUtils {
     ...
     * @return
     */
    public static String getDate(long dateTime, String year, String month, String day, String hh, String mm) {
//        hh:mm:ss
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy" + year + "MM" + month + "dd" + day + "hh" + hh + "mm" + mm + "ss");
        String sd = sdf.format(new Date(Long.parseLong(String.valueOf(dateTime * 1000))));   // 时间戳转换成时间
        return sd;
    }
    public static String getDateTime(long dateTime, String year, String month, String day, String hh) {
//        hh:mm:ss
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy" + year + "MM" + month + "dd" + day + "hh" + hh + "mm" );
        String sd = sdf.format(new Date(Long.parseLong(String.valueOf(dateTime * 1000))));   // 时间戳转换成时间
        return sd;
    }

    public static String getDateDay(long dateTime, String year, String month) {
//        hh:mm:ss
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy" + year + "MM" + month + "dd");
        String sd = sdf.format(new Date(Long.parseLong(String.valueOf(dateTime * 1000))));   // 时间戳转换成时间
        return sd;
    }

    public static String getDateMoth(long dateTime, String month) {
//        hh:mm:ss
        SimpleDateFormat sdf = new SimpleDateFormat("MM" + month + "dd");
        String sd = sdf.format(new Date(Long.parseLong(String.valueOf(dateTime * 1000))));   // 时间戳转换成时间
        return sd;
    }
    /**
     * @param rel_time  传入服务器时间戳10位 返回两个时间差
     * @return
     */
    public static String getTimeHours(long rel_time) {
        Date currentTime = new Date();
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String date1 = formatter.format(currentTime);
        String date2 = formatData("yyyy-MM-dd HH:mm:ss", rel_time);
        String backStr = "";
     ...
     * @return
     */
    public static String getDateTimeHours(long rel_time) {
        Date currentTime = new Date();
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        String date1 = formatter.format(currentTime);
        String date2 = formatData("yyyy-MM-dd", rel_time);
        String backStr = "";
